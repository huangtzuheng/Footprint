...
public class ThingDAO {
    ...
    // 其它表格欄位名稱
    public static final String ITEM_TITLE = "thing_title";
    public static final String ITEM_PRICE = "thing_price";
    public static final String ITEM_SIZE = "thing_size";
    public static final String ITEM_DESCRIPTION = "thing_description";
    public static final String ITEM_PICTURE = "thing_picture";
